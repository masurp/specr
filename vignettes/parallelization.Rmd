...
As we can see, the default (sequential) computation took around a minute (`results_simple$time$callback_msg`) and the parallel computation about half a minute (`results_parall$time$callback_msg`).
...
# Run results
results_parall_2 <- specr(specs, .options = opts)
